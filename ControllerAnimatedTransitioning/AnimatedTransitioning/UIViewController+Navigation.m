...
-(void)setNavigationLeftView:(UIView *)view
{
    ...
    if ([self respondsToSelector:@selector(myNavigationItem)]) {
        ((FFBaseViewController*)self).myNavigationItem.leftBarButtonItems = @[negativeSpacer, buttonItem];
    }else{
...
- (void)setNavigationRightView:(UIView *)view
{
    ...
    if ([self respondsToSelector:@selector(myNavigationItem)]) {
        ((FFBaseViewController *)self).myNavigationItem.rightBarButtonItems = @[negativeSpacer, buttonItem];
    }else{
...
//    self.navigationItem.titleView = view;
    ...
    if ([self respondsToSelector:@selector(myNavigationItem)]) {
        ((FFBaseViewController *)self).myNavigationItem.titleView = view;
    }else{
        self.navigationItem.titleView = view;
    }
}
